  ...
  var runDemoSettings = function() {
    ...
    if ($('#skin-toolbox').length) {
      ...
      (function() {
        ...
        //alert('kalam 3' + settingsObj['headerSkin']);
        //alert(  ' settingsObj[headerSkin] ->'+settingsObj['headerSkin']   );
        try
        {
        	
        	if(settingsObj['headerSkin']==null || settingsObj['headerSkin']=='bg-light' || settingsObj['headerSkin']=='')
        		{
        		settingsObj['headerSkin'] = 'bg-light';
        		gbl_bg_color( 'bg-light'  );
        		}
        	else
        		{
        		gbl_bg_color( settingsObj['headerSkin']   );
        		}
