					...
					<div class="card">
						...
						<div style="text-align: justify; margin: 15px;">
							<ul id="menu">
								...
								<li><a href="#" data-toggle="modal" data-target="#myModal1"><spring:message
											code="label.homePageWithChart.login-registration" /></a></li>
								<li><a href="#" data-toggle="modal" data-target="#myModal1">Forgot
										Password</a></li>
								...
								<li><a
									href="<%=request.getContextPath()%>/passwordPolicy.html"> <span><spring:message
												code="label.homePageWithChart.passwordPolicy" /></span></a></li>
								<li><a href="#">FAQ</a></li>
								<li><a href="<%=request.getContextPath()%>/sitemap.html">Sitemap</a></li>
							</ul>
						</div>
					</div>
				</div>
