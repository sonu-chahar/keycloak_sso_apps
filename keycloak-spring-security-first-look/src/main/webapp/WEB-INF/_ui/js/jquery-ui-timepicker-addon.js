...
(function ($) {
	...
	$.datepicker._updateDatepicker = function (inst) {
		...
		var bottomLayer = $(".ui-datepicker").append("<div ui='.datetimepicker' />");
		bottomLayer.append(html1);
		bottomLayer.append("Hour ");
		bottomLayer.append(html2);
		bottomLayer.append("Min ");
		bottomLayer.append(html3);
		bottomLayer.append("AM/PM ");
	...
	function DateTimePicker(options) {
		...
		for (var i = 1; i <= 12; i++) html1 = hourHTML.append("<option>" + i + "</option");
		for (var i = 0; i < 60; i = i + 5) html2 = minutsHTML.append("<option>" + i + "</option");
		html3 = secondHTML.append("<option>AM</option");
		html3 = secondHTML.append("<option>PM</option");
	}
	...
	DateTimePicker.prototype = {
		...
		innerOption: function ($this) {
			...
			return {
				showOn: "button",
				buttonImage: appctx+"/images/index.jpeg",
