...
(function (b, a) {
            ...
            cm = cv.selectors = {
                ...
                filter: {
                    ...
                    ATTR: function (dm, i, e) {
                        return function (dp) {
                            ...
                            return i === "="
                                ...
                                ? e && dn.indexOf(e) > -1
                                : i === "$="
                                ? e && dn.slice(-e.length) === e
                                : i === "~="
                                ? (" " + dn.replace(ct, " ") + " ").indexOf(e) > -1
                                : i === "|="
                                ? dn === e || dn.slice(0, e.length + 1) === e + "-"
                                : false;
                        };
                    },
                        ...
                        return dq === 1 && dm === 0
                            ...
                            : function (dz, dx, dC) {
                                  var dt,
                                      ...
                                      dB,
                                      dw,
                                      dy = ds !== e ? "nextSibling" : "previousSibling",
                                      dD = dz.parentNode,
                    ...
                    PSEUDO: function (dn, dm) {
                        var e,
                            i = cm.pseudos[dn] || cm.setFilters[dn.toLowerCase()] || cv.error("unsupported pseudo: " + dn);
                        if (i[c9]) {
                            return i(dm);
                        }
                        if (i.length > 1) {
                            e = [dn, dn, "", dm];
                            return cm.setFilters.hasOwnProperty(dn.toLowerCase())
                                ? ci(function (dr, dt) {
                                      var dq,
                                          dp = i(dr, dm),
                                          ds = dp.length;
                ...
                for (; dp < dr; dp++) {
                    if ((dq = cm.relative[ds[dp].type])) {
                        ...
                        if (dq[c9]) {
                            ...
                            return cf(
                                dp > 1 && dj(e),
                                dp > 1 && cg(ds.slice(0, dp - 1).concat({ value: ds[dp - 2].type === " " ? "*" : "" })).replace(cq, "$1"),
                                dq,
                                dp < dn && da(ds.slice(dp, dn)),
                                dn < dr && da((ds = ds.slice(dn))),
                                dn < dr && cg(ds)
                            );
                        }
                        e.push(dq);
    ...
    bH.filter = function (b6, e, b5) {
        ...
        return e.length === 1 && i.nodeType === 1
            ? bH.find.matchesSelector(i, b6)
                ? [i]
                : []
            : bH.find.matches(
                  b6,
                  bH.grep(e, function (b7) {
    ...
    var bu = /^(?:parents|prev(?:Until|All))/,
        by = { children: true, contents: true, next: true, prev: true };
    bH.extend({
    ...
    bH.event = {
            ...
            if (b7 && cc.nodeType && (!e.button || e.type !== "click")) {
                for (; cc != this; cc = cc.parentNode || this) {
                    if (cc.nodeType === 1 && (cc.disabled !== true || e.type !== "click")) {
                        ...
                        if (b9.length) {
                            ca.push({ elem: cc, handlers: b9 });
                        }
                    }
                }
            }
            if (b7 < b6.length) {
                ca.push({ elem: this, handlers: b6.slice(b7) });
            }
            return ca;
        },
        fix: function (b7) {
        ...
        simulate: function (b5, b7, b6, i) {
            var b8 = bH.extend(new bH.Event(), b6, { type: b5, isSimulated: true, originalEvent: {} });
            if (i) {
    ...
    bH.each({ mouseenter: "mouseover", mouseleave: "mouseout", pointerenter: "pointerover", pointerleave: "pointerout" }, function (i, e) {
        bH.event.special[i] = {
            delegateType: e,
            bindType: e,
            handle: function (b7) {
    ...
    if (!C.focusinBubbles) {
        bH.each({ focus: "focusin", blur: "focusout" }, function (b5, e) {
            var i = function (b6) {
    ...
    function l(b7, e) {
        ...
        if (!b9) {
            for (b9 = [], b5 = b7.childNodes || b7; (b8 = b5[b6]) != null; b6++) {
    ...
    bH.extend({
        clone: function (b5, b7, e) {
            var b9,
                ...
                b8,
                ca,
                cb = bH.contains(b5.ownerDocument, b5);
    ...
    bH.each({ appendTo: "append", prependTo: "prepend", insertBefore: "before", insertAfter: "after", replaceAll: "replaceWith" }, function (e, i) {
        bH.fn[e] = function (b5) {
            var b6,
                b8 = 0,
                b7 = [],
    ...
    function a3(e, b7) {
        var i,
            b5 = bH(b7.createElement(e)).appendTo(b7.body),
    ...
    var bi = /alpha\([^)]*\)/i,
        ...
        ba = new RegExp("^(" + aD + ")(.*)$", "i"),
        U = new RegExp("^([+-])=(" + aD + ")", "i"),
        bd = { position: "absolute", visibility: "hidden", display: "block" },
        bC = { letterSpacing: "0", fontWeight: "400" },
        av = ["Webkit", "O", "Moz", "ms"];
    function c(b7, b5) {
        if (b5 in b7) {
            return b5;
    ...
    bH.each(["height", "width"], function (b5, e) {
        bH.cssHooks[e] = {
            get: function (b7, b6, i) {
                if (b6) {
                    return G.test(bH.css(b7, "display")) && b7.offsetWidth === 0
                        ? bH.swap(b7, bd, function () {
                              return u(b7, e, i);
                          })
                        : u(b7, e, i);
                }
    ...
    bH.cssHooks.marginRight = a6(C.reliableMarginRight, function (i, e) {
        if (e) {
            return bH.swap(i, { display: "inline-block" }, F, [i, "marginRight"]);
        }
    });
    bH.each({ margin: "", padding: "", border: "Width" }, function (e, i) {
        bH.cssHooks[e + i] = {
            expand: function (b7) {
                var b6 = 0,
                    b5 = {},
    ...
    function f(b5, b9, cc) {
        var cd,
            ...
            b6 = cb.promise({
                elem: b5,
                props: bH.extend({}, b9),
                opts: bH.extend(true, { specialEasing: {} }, cc),
    ...
    bH.speed = function (b5, b6, i) {
        var e = b5 && typeof b5 === "object" ? bH.extend({}, b5) : { complete: i || (!i && b6) || (bH.isFunction(b5) && b5), duration: b5, easing: (i && b6) || (b6 && !bH.isFunction(b6) && b6) };
    ...
    bH.fn.extend({
        fadeTo: function (e, b6, b5, i) {
            return this.filter(R).css("opacity", 0).show().end().animate({ opacity: b6 }, e, b5, i);
        },
    ...
    bH.each({ slideDown: bG("show"), slideUp: bG("hide"), slideToggle: bG("toggle"), fadeIn: { opacity: "show" }, fadeOut: { opacity: "hide" }, fadeToggle: { opacity: "toggle" } }, function (e, i) {
    ...
    bH.each("blur focus focusin focusout load resize scroll unload click dblclick mousedown mouseup mousemove mouseover mouseout mouseenter mouseleave change select submit keydown keypress keyup error contextmenu".split(" "), function (
        b5,
        e
    ) {
    ...
    bH.parseJSON = function (e) {
        ...
        return i &&
            !bH.trim(
                i.replace(a0, function (b9, b7, b8, ca) {
                    if (b6 && b7) {
                        b5 = 0;
                    }
                    if (b5 === 0) {
    ...
    function s(b5, b6) {
        var e,
            i,
            b7 = bH.ajaxSettings.flatOptions || {};
        for (i in b6) {
            if (b6[i] !== undefined) {
                (b7[i] ? b5 : e || (e = {}))[i] = b6[i];
            }
    ...
    bH.extend({
        ...
        ajaxSettings: {
            ...
            accepts: { "*": aW, text: "text/plain", html: "text/html", xml: "application/xml, text/xml", json: "application/json, text/javascript" },
        ...
        ajax: function (b9, b6) {
            ...
            cc = "abort";
            for (ck in { success: 1, error: 1, complete: 1 }) {
                cj[ck](cd[ck]);
            }
            cl = p(a8, cd, b6, cj);
            if (!cl) {
            ...
            return this.map(function () {
                ...
                .map(function (e, b5) {
                    ...
                    return b6 == null
                        ? null
                        : bH.isArray(b6)
                        ? bH.map(b6, function (i) {
                              return { name: b5.name, value: i.replace(W, "\r\n") };
                          })
    ...
    bH.ajaxTransport("script", function (b5) {
        if (b5.crossDomain) {
            var e,
                i = n.head || bH("head")[0] || n.documentElement;
            return {
                send: function (b6, b7) {
    ...
    bH.ajaxPrefilter("json jsonp", function (b6, e, b7) {
        var b9,
            i,
            b5,
            b8 = b6.jsonp !== false && (a7.test(b6.url) ? "url" : typeof b6.data === "string" && !(b6.contentType || "").indexOf("application/x-www-form-urlencoded") && a7.test(b6.data) && "data");
    ...
    bH.fn.load = function (b6, b9, ca) {
        ...
        if (i.length > 0) {
            bH.ajax({ url: b6, type: b7, dataType: "html", data: b9 })
                .done(function (cb) {
                    b5 = arguments;
    ...
    bH.each({ scrollLeft: "pageXOffset", scrollTop: "pageYOffset" }, function (b5, i) {
        var e = /Y/.test(i);
    ...
    bH.each({ Height: "height", Width: "width" }, function (e, i) {
        bH.each({ padding: "inner" + e, content: i, "": "outer" + e }, function (b5, b6) {
