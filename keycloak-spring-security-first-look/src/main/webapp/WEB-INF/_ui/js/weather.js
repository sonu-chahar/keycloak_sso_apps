    ...
    resizeBackground: function() {
       ...
       /* c.weatherCanvas.width  = window.innerWidth;
        ...
        c.lightningCanvas.height = window.innerHeight;*/
		  ...
		  c.weatherCanvas.width  = 220;
		   
        c.weatherCanvas.height = 100;
        c.rainCanvas.width  = 220;
        c.rainCanvas.height = 100;
        c.cloudCanvas.width  = 220;
        c.cloudCanvas.height = 100;
        c.timeCanvas.width  = 220;
        c.timeCanvas.height = 100;
        c.lightningCanvas.width =220;
        c.lightningCanvas.height = 100;
