...
import com.chahar.keycloak.sms.producer.LogsSmsProducer;
import com.chahar.keycloak.sms.producer.SmsProducer;
import com.chahar.keycloak.sms.utils.MobileNumberUtils;
import com.chahar.keycloak.sms.utils.SmsCodeUtils;
import com.chahar.keycloak.sms.utils.UserAttributeUtils;
...
public class SmsService {
    ...
    public void smsChallenge(SmsContext context) {
        ...
        if (smsCodeUtils.smsStoreIsEmpty(context)) {
            ...
            try {
                smsProducer.produce(message, mobileNumber,user.getEmail());
            } catch (Exception ex) {
