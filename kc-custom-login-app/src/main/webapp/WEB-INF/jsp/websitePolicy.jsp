												...
												<div class="panel-group" id="accordion" role="tablist"
														...
														<div class="panel-heading" role="tab" id="headingOne">
															<h3 class="panel-title" style="color: #e03545;">
																<a data-toggle="collapse" data-parent="#accordion"
																	...
																	<spring:message
																		code="label.websitePolicy.privacyHeading" /><em
																	class="more-less glyphicon glyphicon-minus"></em>
																</a>
															</h3>
														...
														<div id="collapseOne" class="panel-collapse collapse in"
															...
															<div class="panel-body" style="text-align: justify;">
																<ul>
																	<li><p>
																			<spring:message
																				code="label.websitePolicy.privacy-li1" />
																		</p></li>
																	<li><p>
																			<spring:message
																				code="label.websitePolicy.privacy-li2" />
																		</p></li>
																	<li><p>
																			<spring:message
																				code="label.websitePolicy.privacy-li3" />
																		</p></li>
																	<li><p>
																			<spring:message
																				code="label.websitePolicy.privacy-li4" />
																		</p></li>
																	<li><p>
																			<spring:message
																				code="label.websitePolicy.privacy-li5" />
																		</p></li>
																	<li><p>
																			<spring:message
																				code="label.websitePolicy.privacy-li6" />
																		</p></li>
																</ul>
															</div>
														</div>
													...
													<div class="panel-default">
														<div class="panel-heading" role="tab" id="headingTwo">
															<h3 class="panel-title" style="color: #e03545;">
																<a class="collapsed" data-toggle="collapse"
																	...
																	style="margin-right: 85%;"> <spring:message
																		code="label.websitePolicy.copyrightHeading" /><em
														...
														<div id="collapseTwo" class="panel-collapse collapse"
															...
															<div class="panel-body" style="text-align: justify;">
																<spring:message
																	code="label.websitePolicy.copyright-body" />
															</div>
														</div>
													</div>
													<br>
														...
														<div class="panel-heading" role="tab" id="headingThree">
															<h3 class="panel-title" style="color: #e03545;">
																<a class="collapsed" data-toggle="collapse"
																	...
																	style="margin-right: 85%;"> <spring:message
																		code="label.websitePolicy.hyperLinkingHeading" /> <em
																	class="more-less glyphicon glyphicon-plus"></em>
																</a>
															</h3>
														</div>
														<div id="collapseThree" class="panel-collapse collapse"
															...
															<div class="panel-body" style="text-align: justify;">
																<strong><spring:message
																		code="label.websitePolicy.hyperLink1-heading" /> </strong>
																<p>
																	<spring:message
																		code="label.websitePolicy.hyperLink1-body" />
																</p>
																<strong> <spring:message
																		code="label.websitePolicy.hyperLink2-heading" /></strong>
																<p>
																	<spring:message
																		code="label.websitePolicy.hyperLink2-body" />
																</p>
															</div>
														</div>
													</div>
