...
/* 	if ($("#fWaterConsumerNumber").val() == "") {
	...
	if(file!= null){
		file_size=file.size;
		if(file.size>50000) {
			alert("File size should not be greater than 1024kb!");
			return false;
		} 
	}
}
...
$(document).ready(function() {
	...
	if(${userMaster.employeeCode ne null}){
		$("#fEmployeeCode").val('${userMaster.employeeCode}');
	}
	
	if(${userMaster ne null} && ${userMaster.userType eq 'ndmcEmployee'} && ${userMaster.isEmployeeVerified eq false }){
		$( "#bHiddenBtnForEmployeeCodeBSModal" ).trigger( "click" );
	}
	...
	//if ($('#fUserType').val()=='ndmcEmployee'){
		/* alert("abc");
		var settings = {
		  "url": "https://eservices.ndmc.gov.in/emp_api/Emp/emp_dtls",
		  "method": "GET",
		  "timeout": 0,
		  "headers": {
		    "API_KEY": "a474bd87e4e84938a71c35775e1788ce",
		    "Content-Type": "application/json"
		  },
		  "data": JSON.stringify(313916),
		};
		...
		/* var data = JSON.stringify(313916);
		...
		xhr.open("GET", "https://eservices.ndmc.gov.in/emp_api/Emp/emp_dtls/313916");
		xhr.setRequestHeader("API_KEY", "a474bd87e4e84938a71c35775e1788ce");
