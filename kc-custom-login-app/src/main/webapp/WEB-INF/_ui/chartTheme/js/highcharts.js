...
(function (E, X) {
    ...
    function K(a, b, c) {
        ...
        else if (q(b) && Y(b)) for (d in b) a.setAttribute(d, b[d]);
        return e;
    }
    function ta(a) {
        return Ia(a) ? a : [a];
            ...
            if (d) {
                ...
                if (f.length)
                    (f = f.join(":")),
                        ...
                        (h = N.lang),
                        (i = void 0),
                        /f$/.test(f) ? ((i = (i = f.match(g)) ? i[1] : -1), e !== null && (e = B.numberFormat(e, i, h.decimalPoint, f.indexOf(",") > -1 ? h.thousandsSep : ""))) : (e = Qa(f, e));
            }
            k.push(e);
            a = a.slice(c + 1);
            c = (d = !d) ? "}" : "{";
    ...
    var z,
        ...
        ca = y && y.createElementNS && !!y.createElementNS(Fa, "svg").createSVGRect,
    ...
    pb.prototype = {
        dSetter: function () {
            var a = this.paths[0],
                ...
                f;
            if (d === 1) c = this.toD;
            else if (e === b.length && d < 1) for (; e--; ) (f = parseFloat(a[e])), (c[e] = isNaN(f) ? a[e] : d * parseFloat(b[e] - f) + f);
            else c = b;
            this.elem.attr("d", c);
        },
        update: function () {
    ...
    Ab = function (a) {
        ...
        return { top: a.top + (E.pageYOffset || b.scrollTop) - (b.clientTop || 0), left: a.left + (E.pageXOffset || b.scrollLeft) - (b.clientLeft || 0) };
    };
    Oa = function (a) {
    ...
    Wa = function (a, b, c) {
        ...
        for (h in b)
            (g = new pb(a, c, h)),
                (f = null),
                h === "d" ? ((g.paths = g.initPath(a, a.d, b.d)), (g.toD = b.d), (d = 0), (f = 1)) : a.attr ? (d = a.attr(h)) : ((d = parseFloat(ja(a, h)) || 0), h !== "opacity" && (e = "px")),
                f || (f = b[h]),
    ...
    N = {
        ...
        global: { useUTC: !0, canvasToolsURL: "http://code.highcharts.com/modules/canvas-tools.js", VMLRadialGradientURL: "http://code.highcharts.com/4.2.3/gfx/vml-radial-gradient.png" },
        chart: {
            borderColor: "#4572A7",
            borderRadius: 0,
    ...
    O.prototype = {
        ...
        colorGradient: function (a, b, c) {
            ...
            if (f) {
                ...
                j = a.stops;
                n = c.radialReference;
                Ia(g) && (a[f] = g = { x1: g[0], y1: g[1], x2: g[2], y2: g[3], gradientUnits: "userSpaceOnUse" });
                ...
                i[s]
                    ? (n = i[s].attr("id"))
                    : ((g.id = n = "highcharts-" + zb++),
                      (i[s] = k = d.createElement(f).attr(g).add(d.defs)),
                      (k.radAttr = h),
                      (k.stops = []),
                      o(j, function (a) {
                  ...
                  o(a.split(/\s?,\s?/g), function (a) {
                      ...
                      (f = a[a.length - 2]) &&
                          o(c, function (a, c) {
                              ...
                              g = a.cloneNode(1);
                              K(g, { class: "highcharts-text-shadow", fill: e, stroke: e, "stroke-opacity": 1 / t(C(f), 3), "stroke-width": f, "stroke-linejoin": "round" });
                              b.insertBefore(g, d);
                          });
                  }));
        },
                ...
                if (h.namespaceURI === Fa || d.forExport) {
                    try {
                        (l =
                            ...
                            Ma && j.textShadow ? ((k = j.textShadow), (j.textShadow = "")) : l && l("none"),
                            (c = h.getBBox ? u({}, h.getBBox()) : { width: h.offsetWidth, height: h.offsetHeight }),
        ...
        shadow: function (a, b, c) {
            ...
            if (a) {
                ...
                for (e = 1; e <= i; e++) {
                    f = g.cloneNode(0);
                    h = i * 2 + 1 - 2 * e;
                    K(f, { isShadow: "true", stroke: a.color || "black", "stroke-opacity": k * e, "stroke-width": h, transform: "translate" + j, fill: "none" });
    ...
    Ca.prototype = {
        ...
        init: function (a, b, c, d, e, f) {
            ...
            this.alignedObjects = [];
            this.url =
                (Ma || mb) && y.getElementsByTagName("base").length
                    ? E.location.href
                          .replace(/#.*?$/, "")
                          .replace(/([\('\)])/g, "\\$1")
                          .replace(/ /g, "%20")
        ...
        buildText: function (a) {
            for (
                var b = a.element,
                    ...
                    m = j && j.lineHeight,
                    n = j && j.textShadow,
                    r = j && j.textOverflow === "ellipsis",
                    s = g.length,
                    R = l && !a.added && this.box,
                    v = function (a) {
                        return m ? C(m) : c.fontMetrics(/(px|em)$/.test(a && a.style.fontSize) ? a.style.fontSize : (j && j.fontSize) || c.style.fontSize || 12, a).h;
                    },
                    x = function (a) {
                ...
                b.removeChild(g[s]);
            !f && !n && !r && e.indexOf(" ") === -1
                ? b.appendChild(y.createTextNode(x(e)))
                : ((h = /<.*style="([^"]+)".*>/),
                  (i = /<.*href="(http[^"]+)".*>/),
                  R && R.appendChild(b),
                  (e = f
                      ...
                      o(g, function (e) {
                          if (e !== "" || g.length === 1) {
                              ...
                              if (e !== " ") {
                                  ...
                                  if (l) {
                                      for (
                                          var n = e.replace(/([^\^])-/g, "$1- ").split(" "), R = g.length > 1 || f || (n.length > 1 && j.whiteSpace !== "nowrap"), o, w, q, t = [], u = v(s), A = 1, z = a.rotation, B = e, D = B.length;
                                          (R || r) && (n.length || t.length);

                                      )
                                          (a.rotation = 0),
                                              (o = a.getBBox(!0)),
                                              (q = o.width),
                                              !ca && c.forExport && (q = c.measureSpanWidth(s.firstChild.data, a.styles)),
                                              (o = q > l),
                                              w === void 0 && (w = o),
                                              r && w
                                                  ? ((D /= 2),
                                                    B === "" || (!o && D < 0.5) ? (n = []) : (o && (w = !0), (B = e.substring(0, B.length + (o ? -1 : 1) * ua(D))), (n = [B + (l > 3 ? "\u2026" : "")]), s.removeChild(s.firstChild)))
                                                  : !o || n.length === 1
                                                  ? ((n = t), (t = []), n.length && (A++, (s = y.createElementNS(Fa, "tspan")), K(s, { dy: u, x: k }), p && K(s, "style", p), b.appendChild(s)), q > l && (l = q))
                                                  : (s.removeChild(s.firstChild), t.unshift(n.pop())),
                                              n.length && s.appendChild(y.createTextNode(n.join(" ").replace(/- /g, "-")));
        ...
        symbol: function (a, b, c, d, e, f) {
            var g = this,
                ...
                j,
                l;
            if (i) (h = this.path(i)), u(h, { symbolName: a, x: b, y: c, width: d, height: e }), f && u(h, f);
            else if (k.test(a))
                (l = function (a, b) {
                    a.element && (a.attr({ width: b[0], height: b[1] }), a.alignByTranslate || a.translate(A((d - b[0]) / 2), A((e - b[1]) / 2)));
                }),
                    (j = a.match(k)[1]),
                    (a = Nb[j] || (f && f.width && f.height && [f.width, f.height])),
                    (h = this.image(j).attr({ x: b, y: c })),
                    (h.isImg = !0),
                    a
                        ? l(h, a)
        ...
        symbols: {
            ...
            callout: function (a, b, c, d, e) {
                ...
                h && h > c && e > b + g && e < b + d - g
                    ? i.splice(13, 3, "L", a + c, e - 6, a + c + 6, e, a + c, e + 6, a + c, b + d - f)
                    : h && h < 0 && e > b + g && e < b + d - g
                    ? i.splice(33, 3, "L", a, e + 6, a - 6, e, a, e - 6, a, b + f)
                    : e && e > d && h > a + g && h < a + c - g
                    ? i.splice(23, 3, "L", h + 6, b + d, h, b + d + 6, h - 6, b + d, a + f, b + d)
                    : e && e < 0 && h > a + g && h < a + c - g && i.splice(3, 3, "L", h - 6, b, h, b - 6, h + 6, b, c - f, b);
                return i;
            },
        },
        ...
        label: function (a, b, c, d, e, f, g, h, i) {
            ...
            Bb = function () {
                ...
                if (y) {
                    if (!m) (a = ba), (b = (h ? -B : 0) + ba), (j.box = m = d ? k.symbol(d, a, b, j.width, j.height, gb) : k.rect(a, b, j.width, j.height, 0, gb["stroke-width"])), m.isImg || m.attr("fill", "none"), m.add(j);
            ...
            if (this.added) {
                ...
                if (b.tagName === "SPAN") {
                    ...
                    if (m !== this.cTT) {
                        ...
                        if (b.offsetWidth > j && /[ \-]/.test(b.textContent || b.innerText)) L(b, { width: j + "px", display: "block", whiteSpace: l || "normal" }), (this.hasTextWidth = !0);
                        else if (this.hasTextWidth) L(b, { width: "", display: "", whiteSpace: l || "nowrap" }), (this.hasTextWidth = !1);
                        ...
                        if (((b = a.div), !b)) {
                            ...
                            o(j.reverse(), function (a) {
                                var d,
                                    e = K(a.element, "class");
                                e && (e = { className: e });
                                b = a.div = a.div || Z(La, e, { position: "absolute", left: (a.translateX || 0) + "px", top: (a.translateY || 0) + "px" }, b || c);
                                d = b.style;
                                u(a, {
    ...
    if (!ca && !ha) {
        J = {
            ...
            setSpanRotation: function () {
                var a = this.rotation,
                    b = U(a * ga),
                    c = $(a * ga);
                L(this.element, { filter: a ? ["progid:DXImageTransform.Microsoft.Matrix(M11=", b, ", M12=", -c, ", M21=", c, ", M22=", b, ", sizingMethod='auto expand')"].join("") : "none" });
            },
            ...
            clip: function (a) {
                ...
                a
                    ? ((c = a.members),
                      ...
                      (a = a.getCSS(b)))
                    : (b.destroyClip && b.destroyClip(), (a = { clip: lb ? "inherit" : "rect(auto)" }));
                return b.css(a);
            },
        ...
        J.prototype.ySetter = J.prototype.widthSetter = J.prototype.heightSetter = J.prototype.xSetter;
        var Cb = {
            Element: J,
                ...
                return u(e, {
                    ...
                    getCSS: function (a) {
                        var b = a.element,
                            ...
                            b = e + this.width,
                            f = d + this.height,
                            d = { clip: "rect(" + A(a ? e : d) + "px," + A(a ? f : b) + "px," + A(a ? b : f) + "px," + A(a ? d : e) + "px)" };
            ...
            color: function (a, b, c, d) {
                ...
                if (i) {
                    var j,
                        ...
                        q = [],
                        ba = function () {
                            h = ['<fill colors="' + q.join(",") + '" opacity="', s, '" o:opacity2="', r, '" type="', i, '" ', x, 'focus="100%" method="any" />'];
                    ...
                    if (c === "fill")
                        if (i === "gradient") (c = m.x1 || m[0] || 0), (a = m.y1 || m[1] || 0), (n = m.x2 || m[2] || 0), (m = m.y2 || m[3] || 0), (x = 'angle="' + (90 - (W.atan((m - a) / (n - c)) * 180) / ra) + '"'), ba();
                            ...
                            var k = m.r,
                                ...
                                y,
                                k = function () {
                                    z && ((y = d.getBBox()), (A += (z[0] - y.x) / y.width - 0.5), (B += (z[1] - y.y) / y.height - 0.5), (t *= z[2] / y.width), (u *= z[2] / y.height));
            ...
            invertChild: function (a, b) {
                ...
                L(a, { flip: "x", left: C(d.width) - (e ? C(e.top) : 1), top: C(d.height) - (e ? C(e.left) : 1), rotation: -90 });
    ...
    Va.prototype = {
        addLabel: function () {
            ...
            this.isFirst = i;
            this.isLast = k;
            b = a.labelFormatter.call({ axis: a, chart: c, isFirst: i, isLast: k, dateTimeLabelFormat: j, value: a.isLog ? fa(na(e)) : e });
        ...
        handleOverflow: function (a) {
            ...
            if (h) h < 0 && c - i * k < f ? (m = A(c / U(h * ga) - f)) : h > 0 && c + i * k > e && (m = A((d - c) / U(h * ga)));
                ...
                ((d = c + (1 - i) * k),
                c - i * k < f ? (j = a.x + j * (1 - i) - f) : d > e && ((j = e - a.x + j * i), (l = -1)),
                (j = F(b.slotWidth, j)),
                j < b.slotWidth && b.labelAlign === "center" && (a.x += l * (b.slotWidth - j - i * (b.slotWidth - F(k, j)))),
                k > j || (b.autoRotation && g.styles.width))
            )
                m = j;
            if (m) {
                n.width = m;
        ...
        render: function (a, b, c) {
            ...
            if (m && v)
                w === "inside" && (v = -v),
                    d.opposite && (v = -v),
                    (h = this.getMarkPath(A, u, v, m * B, g, f)),
                    n ? n.animate({ d: h, opacity: c }) : (this.mark = f.path(h).attr({ stroke: x, "stroke-width": m, opacity: c }).add(d.axisGroup));
            if (i && !isNaN(A))
                (i.xy = u = this.getLabelPosition(A, u, i, g, j, t, a, q)),
                    (this.isFirst && !this.isLast && !p(e.showFirstLabel, 1)) || (this.isLast && !this.isFirst && !p(e.showLastLabel, 1)) ? (ba = !1) : g && !d.isRadial && !j.step && !j.rotation && !b && c !== 0 && this.handleOverflow(u),
                    q && a % q && (ba = !1),
    ...
    B.PlotLineOrBand.prototype = {
        render: function () {
            ...
            if (g) {
                if (((n = b.getPlotLinePath(j, g)), (x = { stroke: s, "stroke-width": g }), l)) x.dashstyle = l;
            } else if (k) {
            ...
            if (m)
                ...
                v))
                    d(r);
            e && q(e.text) && n && n.length && b.width > 0 && b.height > 0 && !n.flat
                ? ((e = D({ align: c && k && "center", x: c ? !k && 4 : 10, verticalAlign: !c && k && "middle", y: c ? (k ? 16 : 10) : k ? 6 : -4, rotation: c && !k && 90 }, e)), this.renderLabel(e, n, k, o))
                : f && f.hide();
            return a;
        },
        ...
        destroy: function () {
            oa(this.axis.plotLinesAndBands, this);
            delete this.axis;
            Sa(this);
        },
    };
    ...
    ka.prototype = {
        ...
        defaultLabelFormatter: function () {
            ...
            else if (f && a >= 1e3) for (; f-- && g === z; ) (c = Math.pow(1e3, f + 1)), a >= c && (b * 10) % c === 0 && e[f] !== null && (g = B.numberFormat(b / c, -1) + e[f]);
        ...
        setTickInterval: function (a) {
            ...
            x = p(b.userMax, d.max);
            h
                ? ((b.linkedParent = c[b.coll][d.linkedTo]), (c = b.linkedParent.getExtremes()), (b.min = p(c.min, c.dataMin)), (b.max = p(c.max, c.dataMax)), d.type !== b.linkedParent.options.type && X(11, 1))
                : (!r && q(n) && (b.dataMin >= n ? ((s = n), (k = 0)) : b.dataMax <= n && ((R = n), (i = 0))), (b.min = p(v, s, b.dataMin)), (b.max = p(x, R, b.dataMax)));
            ...
            b.adjustForMinRange();
            if (!m && !b.axisPointRange && !b.usePercentage && !h && q(b.min) && q(b.max) && (c = b.max - b.min)) !q(v) && k && (b.min -= c * k), !q(x) && i && (b.max += c * i);
            ...
            b.tickInterval =
                b.min === b.max || b.min === void 0 || b.max === void 0
                    ? 1
                    : h && !j && l === b.linkedParent.options.tickPixelInterval
                    ? (j = b.linkedParent.tickInterval)
                    : p(j, this.tickAmount ? (b.max - b.min) / t(this.tickAmount - 1, 1) : void 0, m ? 1 : ((b.max - b.min) * l) / t(b.len, l));
            g &&
                !a &&
                o(b.series, function (a) {
        ...
        getExtremes: function () {
            var a = this.isLog;
            return { min: a ? fa(na(this.min)) : this.min, max: a ? fa(na(this.max)) : this.max, dataMin: this.dataMin, dataMax: this.dataMax, userMin: this.userMin, userMax: this.userMax };
        },
        ...
        unsquish: function () {
            ...
            c
                ? (l = !b.staggerLines && !b.step && (q(h) ? [h] : f < p(b.autoRotationLimit, 80) && b.autoRotation)) &&
                  o(l, function (a) {
                      var b;
        ...
        renderUnsquish: function () {
            ...
            else if (g && ((l = { width: i + "px" }), !j)) {
                l.textOverflow = "clip";
                for (n = c.length; !f && n--; )
                    if (((r = c[n]), (i = d[r].label)))
                        if ((i.styles.textOverflow === "ellipsis" && i.css({ textOverflow: "clip" }), i.getBBox().height > this.len / c.length - (h.h - h.f) || d[r].labelLength > g)) i.specCss = { textOverflow: "ellipsis" };
            }
        ...
        getOffset: function () {
            ...
            if (k || a.isLinked) {
                if (
                    ...
                    a.renderUnsquish(),
                    s.reserveSpace !== !1 &&
                        (h === 0 || h === 2 || { 1: "left", 3: "right" }[h] === a.labelAlign || a.labelAlign === "center") &&
                        o(e, function (a) {
                            R = t(f[a].getLabelSize(), R);
                        }),
                    a.staggerLines)
                )
                    (R *= a.staggerLines), (a.labelOffset = R * (a.opposite ? -1 : 1));
            } else for (u in f) f[u].destroy(), delete f[u];
            if (r && r.text && r.enabled !== !1) {
                if (!a.axisTitle)
                    (a.axisTitle = c
                        .text(r.text, 0, 0, r.useHTML)
                        .attr({ zIndex: 7, rotation: r.rotation || 0, align: r.textAlign || { low: v ? "right" : "left", middle: "center", high: v ? "left" : "right" }[r.align] })
        ...
        render: function () {
            var a = this,
                ...
                r = d.lineWidth,
                s,
                p = b.hasRendered && q(a.oldMin) && !isNaN(a.oldMin),
                v = a.showAxis,
                x = c.globalAnimation,
                w,
                t;
            ...
            if (a.hasData() || f) {
                ...
                if (
                    ...
                    i[-1] || (i[-1] = new Va(a, -1, null, !0)), i[-1].render(-1);
                m &&
                    o(g, function (c, d) {
                        t = g[d + 1] !== z ? g[d + 1] + n : a.max - n;
                        if (d % 2 === 0 && c < a.max && t <= a.max + (b.polar ? -n : n))
                            j[c] || (j[c] = new B.PlotLineOrBand(a)), (w = c + n), (j[c].options = { from: e ? na(w) : w, to: e ? na(t) : t, color: m }), j[c].render(), (j[c].isActive = !0);
                    });
                if (!a._addedPlotLB)
            ...
            if (r) (s = a.getLinePath(r)), a.axisLine ? a.axisLine.animate({ d: s }) : (a.axisLine = c.path(s).attr({ stroke: d.lineColor, "stroke-width": r, zIndex: 7 }).add(a.axisGroup)), a.axisLine[v ? "show" : "hide"](!0);
        ...
        drawCrosshair: function (a, b) {
            ...
            if (!this.crosshair || (q(b) || !p(d.snap, !0)) === !1) this.hideCrosshair();
                ...
                (p(d.snap, !0) ? q(b) && (c = this.isXAxis ? b.plotX : this.len - b.plotY) : (c = this.horiz ? a.chartX - this.pos : this.len - a.chartY + this.pos),
                ...
                this.hideCrosshair();
            else if (((e = this.categories && !this.isRadial), (f = p(d.width, e ? this.transA : 1)), this.cross)) this.cross.attr({ d: c, visibility: "visible", "stroke-width": f });
            else {
    ...
    ka.prototype.getTimeTicks = function (a, b, c, d) {
        ...
        if (q(b)) {
            ...
            if (k >= G.day) i[wb](k >= G.month ? 1 : j * T(i[$a]() / j));
            ...
            h = i[bb]();
            for (var d = i.getTime(), l = i[ab](), m = i[$a](), n = !g || !!Za, r = (G.day + (g ? Ya(i) : i.getTimezoneOffset() * 6e4)) % G.day; d < c; )
                e.push(d), k === G.year ? (d = kb(h + b * j, 0)) : k === G.month ? (d = kb(h, l + b * j)) : n && (k === G.day || k === G.week) ? (d = kb(h, l, m + b * j * (k === G.day ? 1 : 7))) : (d += k * j), b++;
            e.push(d);
            o(
                Na(e, function (a) {
                    return k <= G.hour && a % G.day === r;
                }),
                function (a) {
                    f[a] = "day";
                }
    ...
    ka.prototype.getLogTickPositions = function (a, b, c, d) {
        ...
        if (a >= 0.5) (a = A(a)), (g = this.getLinearTickPositions(a, b, c));
            ...
            (a = sb(a, null, rb(a))),
            (g = Ba(this.getLinearTickPositions(a, b, c), Da)),
            !d)
        )
    ...
    Pb.prototype = {
        ...
        move: function (a, b, c, d) {
            ...
            u(f, { x: g ? (2 * f.x + a) / 3 : a, y: g ? (f.y + b) / 2 : b, anchorX: h ? z : g ? (2 * f.anchorX + c) / 3 : c, anchorY: h ? z : g ? (f.anchorY + d) / 2 : d });
            e.label.attr(f);
            if (g)
                clearTimeout(this.tooltipTimeout),
        ...
        refresh: function (a, b) {
            ...
            k === !1
                ? this.hide()
                : (this.isHidden && (Oa(d), d.attr("opacity", 1).show()),
                  d.attr({ text: k }),
                  (l = e.borderColor || a.color || i.color || "#606060"),
                  d.attr({ stroke: l }),
                  this.updatePosition({ plotX: f, plotY: g, negative: a.negative, ttBelow: a.ttBelow, h: h[2] || 0 }),
                  (this.isHidden = !1));
    ...
    Xa.prototype = {
        ...
        runPointActions: function (a) {
            ...
            g && (e ? g.noSharedTooltip : g.directTouch) && f
                ? (l = [f])
                : (o(c, function (b) {
                  ...
                  o(j, function (a) {
                      a &&
                          o(["dist", "distX"], function (b, c) {
                              typeof a[b] === "number" && a[b] < h[c] && ((h[c] = a[b]), (l[c] = a));
                          });
                  }));
            if (e) for (b = j.length; b--; ) (j[b].clientX !== l[1].clientX || j[b].series.noSharedTooltip) && j.splice(b, 1);
            if (l[0] && (l[0] !== this.prevKDPoint || (d && d.isHidden)))
                if (e && !l[0].series.noSharedTooltip)
                    j.length && d && d.refresh(j, a),
                        o(j, function (b) {
            ...
            o(e ? j : [p(l[1], f)], function (b) {
                var c = b && b.series;
                c &&
                    o(["xAxis", "yAxis", "colorAxis"], function (d) {
        ...
        drag: function (a) {
            ...
            if (!m || !m.touch)
                if ((d < h ? (d = h) : d > h + k && (d = h + k), e < i ? (e = i) : e > i + j && (e = i + j), (this.hasDragged = Math.sqrt(Math.pow(n - d, 2) + Math.pow(r - e, 2))), this.hasDragged > 10)) {
                    ...
                    if (b.hasCartesianSeries && (this.zoomX || this.zoomY) && l && !s && !m)
                        this.selectionMarker = m = b.renderer
                            .rect(h, i, f ? 1 : k, g ? 1 : j, 0)
        ...
        onContainerMouseMove: function (a) {
            var b = this.chart;
            if (!q(ea) || !S[ea] || !S[ea].mouseIsDown) ea = b.index;
            a = this.normalize(a);
            a.returnValue = !1;
        ...
        onContainerClick: function (a) {
            ...
            b.cancelClick ||
                (c && this.inClass(a.target, "highcharts-tracker")
                    ? (H(c.series, "click", u(a, { point: c })), b.hoverPoint && c.firePointEvent("click", a))
                    : (u(a, this.getCoordinates(a)), b.isInsidePlot(a.chartX - d, a.chartY - e) && H(b, "click", a)));
        },
        ...
        destroy: function () {
            ...
            eb || (V(y, "mouseup", this.onDocumentMouseUp), V(y, "touchend", this.onDocumentTouchEnd));
    ...
    if (E.PointerEvent || E.MSPointerEvent) {
        var va = {},
            ...
            Eb = function (a, b, c, d) {
                if ((a.pointerType === "touch" || a.pointerType === a.MSPOINTER_TYPE_TOUCH) && S[ea]) d(a), (d = S[ea].pointer), d[b]({ type: c, target: a.currentTarget, preventDefault: Aa, touches: Sb() });
            };
        u(Xa.prototype, {
        ...
        fb(Xa.prototype, "init", function (a, b, c) {
            a.call(this, b, c);
            this.hasZoom && L(b.container, { "-ms-touch-action": "none", "touch-action": "none" });
        });
    ...
    ob.prototype = {
        ...
        colorizeItem: function (a, b) {
            ...
            e && e.attr({ stroke: h });
            if (f) {
                if (g && f.isMarker) for (k in ((i.stroke = h), (g = a.convertAttribs(g)), g)) (d = g[k]), d !== z && (i[k] = d);
                f.attr(i);
            }
        },
        ...
        positionCheckboxes: function (a) {
            ...
            if (b)
                (c = b.translateY),
                    o(this.allItems, function (f) {
                        var g = f.checkbox,
                            h;
                        g && ((h = c + e + g.y + (a || 0) + 3), L(g, { left: b.translateX + f.checkboxOffset + g.x - 20 + "px", top: h + "px", display: h > c - 6 && h < c + d - 6 ? "" : "none" }));
                    });
        },
        ...
        renderItem: function (a) {
            ...
            if (!o) {
                ...
                a.legendItem = o = c
                    .text("", l ? f + g : -g, this.baseline || 0, w)
                    .css(D(a.visible ? h : i))
                    .attr({ align: l ? "left" : "right", zIndex: 2 })
                    .add(a.legendGroup);
                if (!this.baseline) (this.fontMetrics = c.fontMetrics(h.fontSize, o)), (this.baseline = this.fontMetrics.f + 3 + r), o.attr("y", this.baseline);
        ...
        adjustMargins: function (a, b) {
            ...
            this.display &&
                !d.floating &&
                o([/(lth|ct|rth)/, /(rtv|rm|rbv)/, /(rbh|cb|lbh)/, /(lbv|lm|ltv)/], function (f, g) {
        ...
        render: function () {
            ...
            if (l || m) {
                if (i) {
                    ...
                    (a.box = i = c
                        .rect(0, 0, g, h, k.borderRadius, l || 0)
                        .attr({ stroke: k.borderColor, "stroke-width": l || 0, fill: m || "none" })
                        .add(d)
                        .shadow(k.shadow)),
                        (i.isNew = !0);
                i[f ? "show" : "hide"]();
        ...
        scroll: function (a, b) {
            ...
            if (e > 0)
                b !== z && Ua(b, this.chart),
                    this.nav.attr({ translateX: k, translateY: f + this.padding + 7 + this.titleHeight, visibility: "visible" }),
    ...
    (/Trident\/7\.0/.test(za) || Ma) &&
        fb(ob.prototype, "positionItem", function (a, b) {
            var c = this,
                d = function () {
    ...
    hb.prototype = {
        ...
        layOutTitles: function (a) {
            ...
            if (c && (c.css({ width: (f.width || h) + "px" }).align(u({ y: g.fontMetrics(f.style.fontSize, c).b - 3 }, f), !1, "spacingBox"), !f.floating && !f.verticalAlign)) b = c.getBBox().height;
        ...
        getChartSize: function () {
            ...
            if (!q(a)) this.containerHeight = ja(c, "height");
        ...
        cloneRenderTo: function (a) {
            ...
            a
                ...
                : (c && c.parentNode === this.renderTo && this.renderTo.removeChild(c),
                  ...
                  L(b, { position: "absolute", top: "-9999px", display: "block" }),
        ...
        getContainer: function () {
            ...
            this.container = a = Z(
                ...
                u({ position: "relative", overflow: "hidden", width: d + "px", height: e + "px", textAlign: "left", lineHeight: "normal", zIndex: 0, "-webkit-tap-highlight-color": "rgba(0,0,0,0)" }, c.style),
        ...
        setChartSize: function (a) {
            ...
            b = ua(t(d, h[3]) / 2);
            c = ua(t(d, h[0]) / 2);
            this.clipBox = { x: b, y: c, width: T(this.plotSizeX - t(d, h[1]) / 2 - b), height: t(0, T(this.plotSizeY - t(d, h[2]) / 2 - c)) };
            a ||
        ...
        drawChartBox: function () {
            ...
            if (m) g ? ((g.strokeWidth = -m), g.animate(g.crisp({ x: r, y: p, width: o, height: v }))) : (this.plotBorder = b.rect(r, p, o, v, 0, -m).attr({ stroke: a.plotBorderColor, "stroke-width": m, fill: "none", zIndex: 1 }).add());
            this.isDirtyBox = !1;
        },
        ...
        isReadyToRender: function () {
            var a = this;
            return (!ca && E == E.top && y.readyState !== "complete") || (ha && !E.canvg)
                ? (ha
                      ? Ob.push(function () {
                            a.firstRender();
    ...
    Ha.prototype = {
        ...
        destroy: function () {
            var a = this.series.chart,
                ...
                c;
            a.pointCount--;
            if (b && (this.setState(), oa(b, this), !b.length)) a.hoverPoints = null;
    ...
    Q.prototype = {
            ...
            if (d !== !1 && h && g === h && !e.cropped && !e.hasGroupedData && e.visible)
                ...
                if (n && h > n) {
                    ...
                    if (ma(j)) {
                        ...
                        if (t) for (c = 0; c < h; c++) (j = a[c]), (r[c] = j[0]), (s[c] = j.slice(1, t + 1));
                        else for (c = 0; c < h; c++) (j = a[c]), (r[c] = j[0]), (s[c] = j[1]);
                    else X(12);
        ...
        generatePoints: function () {
            ...
            for (m = 0; m < g; m++) (i = h + m), k ? (l[m] = new f().init(this, [d[m]].concat(ta(e[m])))) : (b[i] ? (j = b[i]) : a[i] !== z && (b[i] = j = new f().init(this, a[i], d[m])), (l[m] = j)), (l[m].index = i);
        ...
        getExtremes: function (a) {
            ...
            for (l = 0; l < d; l++)
                if (
                    ((k = c[l]),
                    (j = a[l]),
                    (i = j !== null && j !== z && (!b.isLog || j.length || j > 0)),
                    (k = this.getExtremesFromAll || this.options.getExtremesFromAll || this.cropped || ((c[l + 1] || k) >= g && (c[l - 1] || k) <= h)),
                    i && k)
                )
        ...
        translate: function () {
            ...
            for (
                ...
                var v = f[a],
                    ...
                    w = v.y;
                n = v.low;
                var u = b && e.stacks[(this.negStacks && w < (l ? 0 : j) ? "-" : "") + this.stackKey];
                if (e.isLog && w !== null && w <= 0) (v.y = w = null), X(10);
                v.plotX = m = F(t(-1e5, c.translate(x, 0, 0, 0, 1, i, this.type === "flags")), 1e5);
                if (b && this.visible && !v.isNull && u && u[x])
                    (o = this.getStackIndicator(o, x, this.index)),
                        (u = u[x]),
                        (w = u.points[o.key]),
                        (n = w[0]),
                        (w = w[1]),
                ...
                v.yBottom = q(n) ? e.translate(n, 0, 1, 0, 1) : null;
            ...
            if (l.enabled !== !1 || this._hasPointMarkers)
                for (f = b.length; f--; )
                    if (((g = b[f]), (d = T(g.plotX)), (e = g.plotY), (j = g.graphic), (n = g.marker || {}), (r = !!g.marker), (a = (v && n.enabled === z) || n.enabled), (o = g.isInside), a && e !== z && !isNaN(e) && g.y !== null))
                        if (((a = g.pointAttr[g.selected ? "select" : ""] || m), (h = a.r), (i = p(n.symbol, this.symbol)), (k = i.indexOf("url") === 0), j))
                            j[o ? "show" : "hide"](!0)
                                .attr(a)
                                .animate(u({ x: d - h, y: e - h }, j.symbolName ? { width: 2 * h, height: 2 * h } : {}));
                        else {
                            if (o && (h > 0 || k))
                                g.graphic = c.renderer
                                    .symbol(i, d - h, e - h, 2 * h, 2 * h, r ? n : l)
                                    .attr(a)
                                    .add(t);
                        }
        ...
        getAttribs: function () {
            ...
            var s = a.zones,
                ...
                v;
            b.marker
                ? ((e.radius = e.radius || c.radius + e.radiusPlus), (e.lineWidth = e.lineWidth || c.lineWidth + e.lineWidthPlus))
                : ((e.color =
                      e.color ||
                      ia(e.color || g)
                ...
                for (; g--; ) {
                    ...
                    if (k) {
                        ...
                        if (!b.marker || (j.negative && !f.fillColor && !e.fillColor))
                            f[a.pointAttrToOptions.fill] =
                                f.color ||
                                (!j.options.color && e[j.negative && h ? "negativeColor" : "color"]) ||
                                ia(j.color)
            ...
            o(a, function (g, j) {
                ...
                g.isNull && !q(b) && j > 0
                    ...
                    : (j === 0 || i
                          ? (n = ["M", g.plotX, g.plotY])
                          : d.getPointSpline
                          ? (n = d.getPointSpline(a, g, j))
                          : f
                          ? ((n = f === 1 ? ["L", n.plotX, m] : f === 2 ? ["L", (n.plotX + l) / 2, n.plotY, "L", (n.plotX + l) / 2, m] : ["L", l, n.plotY]), n.push("L", l, m))
                          : (n = ["L", l, m]),
                      h.push.apply(h, n),
                      (i = !1));
            });
            ...
            if (d.length && (i || k) && l.min !== z)
                i && i.hide(),
                    ...
                    o(d, function (d, o) {
                        ...
                        b.inverted && c.isVML && (h = l.isXAxis ? { x: 0, y: n ? v : x, height: h.width, width: b.chartWidth } : { x: h.y - b.plotLeft - b.spacingBox.x, y: 0, width: h.height, height: b.chartHeight });
        ...
        o([b, "-" + b], function (b) {
            ...
            for (var g = d.length, h, i; g--; )
                if (((h = d[g]), (e = a.getStackIndicator(e, h, a.index)), (f = (i = c[b] && c[b][h]) && i.points[e.key]), (h = f)))
                    (i = i.total ? 100 / i.total : 0), (h[0] = fa(h[0] * i)), (h[1] = fa(h[1] * i)), (a.stackedYData[g] = h[1]);
        });
    };
    ...
    u(hb.prototype, {
        addSeries: function (a, b, c) {
            ...
            a &&
                ((b = p(b, !0)),
                H(e, "addSeries", { options: a }, function () {
                    d = e.initSeries(a);
                    e.isDirtyLegend = !0;
                    e.linkSeries();
                    b && e.redraw(c);
        ...
        showLoading: function (a) {
            var b = this,
                ...
                e = c.loading,
                f = function () {
                    d && L(d, { left: b.plotLeft + "px", top: b.plotTop + "px", width: b.plotWidth + "px", height: b.plotHeight + "px" });
                };
            if (!d) (b.loadingDiv = d = Z(La, { className: "highcharts-loading" }, u(e.style, { zIndex: 10, display: "none" }), b.container)), (b.loadingSpan = Z("span", null, e.labelStyle, d)), M(b, "redraw", f);
            b.loadingSpan.innerHTML = a || c.lang.loading;
            if (!b.loadingShown) L(d, { opacity: 0, display: "" }), Wa(d, { opacity: e.style.opacity }, { duration: e.showDuration || 0 }), (b.loadingShown = !0);
            f();
        },
    ...
    var la = pa(Q, {
                        ...
                        a.push(f[g]),
                            o([-1, 1], function (a) {
                                var c = a === 1 ? "rightNull" : "leftNull",
                                    d = 0,
                                    n = e[b[i + a]];
                                if (n) for (m = h; m >= 0 && m < k; ) (p = n.points[m]), p || (m === h ? (f[g][c] = !0) : j[m] && (q = e[g].points[m]) && (d -= q[1] - q[0])), (m += l);
        ...
        getGraphPath: function (a) {
            var b = Q.prototype.getGraphPath,
                ...
                s = function (b, c, f) {
                    ...
                    o !== void 0 && (i.push({ plotX: j, plotY: o === null ? n : e.toPixels(o, !0), isNull: g }), h.push({ plotX: j, plotY: r === null ? n : e.toPixels(r, !0) }));
                },
                a = a || this.points;
        ...
        drawGraph: function () {
            ...
            o(d, function (d) {
                var f = d[0],
                    g = a[f];
                g ? g.animate({ d: b }) : ((g = { fill: d[2] || d[1], zIndex: 0 }), d[2] || (g["fill-opacity"] = p(c.fillOpacity, 0.75)), (a[f] = a.chart.renderer.path(b).attr(g).add(a.group)));
            });
        },
    ...
    la = la.prototype;
    wa = pa(wa, { type: "areaspline", getStackPoints: la.getStackPoints, getGraphPath: la.getGraphPath, setStackCliffs: la.setStackCliffs, drawGraph: la.drawGraph, drawLegendSymbol: J.drawRectangle });
    I.areaspline = wa;
    aa.column = D(da, {
        borderColor: "#FFFFFF",
        borderRadius: 0,
    ...
    wa = pa(Q, {
        ...
        getColumnMetrics: function () {
            ...
            var i = F(P(c.transA) * (c.ordinalSlope || b.pointRange || c.closestPointRange || c.tickInterval || 1), c.len),
                k = i * b.groupPadding,
                j = (i - 2 * k) / h,
        ...
        drawPoints: function () {
            ...
            o(a.points, function (h) {
                ...
                if (i !== z && !isNaN(i) && h.y !== null)
                    (f = h.shapeArgs),
                        (i = q(a.borderWidth) ? { "stroke-width": a.borderWidth } : {}),
                        (g = h.pointAttr[h.selected ? "select" : ""] || a.pointAttr[""]),
                        k
                            ? (Oa(k), k.attr(i).attr(g)[b.pointCount < e ? "animate" : "attr"](D(f)))
                            : (h.graphic = d[h.shapeType](f)
                                  .attr(i)
                                  .attr(g)
                                  .add(h.group || a.group)
        ...
        animate: function (a) {
            ...
            if (ca)
                a
                    ? ((e.scaleY = 0.001), (a = F(b.pos + b.len, t(b.pos, b.toPixels(c.threshold)))), d ? (e.translateX = a - b.len) : (e.translateY = a), this.group.attr(e))
    ...
    Q.prototype.drawDataLabels = function () {
        ...
        if (d.enabled || a._hasPointLabels)
            a.dlProcessOptions && a.dlProcessOptions(d),
                (k = a.plotGroup("dataLabelsGroup", "data-labels", d.defer ? "hidden" : "visible", d.zIndex || 6)),
                p(d.defer, !0) &&
                    (k.attr({ opacity: +h }),
                    h ||
                        M(a, "afterAnimate", function () {
                            a.visible && k.show();
                ...
                o(e, function (e) {
                    ...
                    if (n && !h) e.dataLabel = n.destroy();
                        ...
                        if (n)
                            ...
                            n = e.dataLabel = j[h ? "text" : "label"](i, 0, -9999, d.shape, null, null, d.useHTML).attr(n).css(u(x, w)).add(k).shadow(d.shadow);
                        }
    ...
    Q.prototype.alignDataLabel = function (a, b, c, d, e) {
        ...
        if (n)
            (d = u({ x: g ? f.plotWidth - i : h, y: A(g ? f.plotHeight - h : i), width: 0, height: 0 }, d)),
                u(c, { width: k.width, height: k.height }),
                l
                    ? ((o = !1),
                      (g = f.renderer.rotCorr(j, l)),
                      (g = { x: d.x + c.x + d.width / 2 + g.x, y: d.y + c.y + d.height / 2 }),
                      b[e ? "attr" : "animate"](g).attr({ align: c.align }),
                      (h = (l + 720) % 360),
                      (h = h > 180 && h < 360),
                      m === "left" ? (g.y -= h ? k.height : 0) : m === "center" ? ((g.x -= k.width / 2), (g.y -= k.height / 2)) : m === "right" && ((g.x -= k.width), (g.y -= h ? 0 : k.height)))
                    : (b.align(c, null, d), (g = b.alignAttr)),
                o ? this.justifyDataLabel(b, c, g, k, d, e) : p(c.crop, !0) && (n = f.isInsidePlot(g.x, g.y) && f.isInsidePlot(g.x + k.width, g.y + k.height)),
                c.shape && !l && b.attr({ anchorX: a.plotX, anchorY: a.plotY });
    ...
    if (I.pie)
        (I.pie.prototype.drawDataLabels = function () {
            ...
            if (a.visible && (e.enabled || a._hasPointLabels)) {
                ...
                o(b, function (a) {
                    if (a.dataLabel && a.visible) B[a.half].push(a), (a.dataLabel._pos = null);
                });
                for (D = 2; D--; ) {
                    var H = [],
                        M = [],
                    ...
                    if (K) {
                        ...
                        if (m > 0) {
                            ...
                            for (C = 0; C < K; C++) {
                                ...
                                if (J < C && H[C] !== null) J = C;
                                else for (x < K - C + J && H[C] !== null && (J = x - K + C); H[J] === null; ) J++;
                                M.push({ i: J, y: H[J] });
                                H[J] = null;
                            }
                            M.sort(L);
                        ...
                        for (C = 0; C < K; C++) {
                            ...
                            if (this.options.size === null)
                                (x = v.width),
                                    z - x < f ? (G[3] = t(A(x - z + f), G[3])) : z + x > h - f && (G[1] = t(A(z + x - h + f), G[1])),
                                    y - b / 2 < 0 ? (G[0] = t(A(-y + b / 2), G[0])) : y + b / 2 > i && (G[2] = t(A(y + b / 2 - i), G[2]));
                        }
                    }
                }
                if (Ea(G) === 0 || this.verifyDataLabelOverflow(G))
                        ...
                        u &&
                            ...
                            o(this.points, function (b) {
                                ...
                                if ((v = b.dataLabel) && v._pos && b.visible)
                                    (E = v._attr.visibility),
                                        (z = v.connX),
                                        (y = v.connY),
                                        (j = l
                                            ? ["M", z + (w[6] === "left" ? 5 : -5), y, "C", z, y, 2 * w[2] - w[4], 2 * w[3] - w[5], w[2], w[3], "L", w[4], w[5]]
                                            : ["M", z + (w[6] === "left" ? 5 : -5), y, "L", w[2], w[3], "L", w[4], w[5]]),
                                        k
                                            ? (k.animate({ d: j }), k.attr("visibility", E))
            ...
            (I.pie.prototype.verifyDataLabelOverflow = function (a) {
                ...
                f < b[2]
                    ? ((b[2] = f), (b[3] = Math.min(/%$/.test(c.innerSize || 0) ? (f * parseFloat(c.innerSize || 0)) / 100 : parseFloat(c.innerSize || 0), f)), this.translate(b), this.drawDataLabels && this.drawDataLabels())
                    : (g = !0);
                return g;
            });
    if (I.column)
                ...
                for (d = e + 1; d < b; ++d)
                    if (
                        ...
                        k &&
                            ...
                            (n = k.parentGroup),
                            (o = j.parentGroup),
                            (p = 2 * (k.box ? 0 : k.padding)),
                            (l = !(
                                m.x + o.translateX > l.x + n.translateX + (k.width - p) ||
                                m.x + o.translateX + (j.width - p) < l.x + n.translateX ||
                                m.y + o.translateY > l.y + n.translateY + (k.height - p) ||
                                m.y + o.translateY + (j.height - p) < l.y + n.translateY
                            ))))
                    )
    ...
    da = B.TrackerMixin = {
        ...
        drawTrackerGraph: function () {
            ...
            k
                ...
                : ((a.tracker = h
                      .path(d)
                      .attr({ "stroke-linejoin": "round", visibility: a.visible ? "visible" : "hidden", stroke: n, fill: c ? n : "none", "stroke-width": b.lineWidth + (c ? 0 : 2 * i), zIndex: 2 })
                      .add(a.group)),
    ...
    u(Ha.prototype, {
        select: function (a, b) {
            ...
            c.firePointEvent(a ? "select" : "unselect", { accumulate: b }, function () {
                ...
                c.setState(a && "select");
                b ||
                    o(e.getSelectedPoints(), function (a) {
        ...
        setState: function (a, b) {
            ...
            if (!((a === this.state && !b) || (this.selected && a !== "select") || (f[a] && f[a].enabled === !1) || (a && (k || (h && i.enabled === !1))) || (a && l.states && l.states[a] && l.states[a].enabled === !1))) {
                if (this.graphic) (g = g && this.graphic.symbolName && o.r), this.graphic.attr(D(o, g ? { x: c - g, y: d - g, width: 2 * g, height: 2 * g } : {})), j && j.hide();
                else {
                    if (a && i)
                        if (((g = i.radius), (l = l.symbol || e.symbol), j && j.currentSymbol !== l && (j = j.destroy()), j)) j[b ? "animate" : "attr"]({ x: c - g, y: d - g });
                        else if (l)
                            (e.stateMarkerGraphic = j = m.renderer
                ...
                if ((c = f[a] && f[a].halo) && c.size) {
                    ...
                    n.attr(u({ fill: this.color || e.color, "fill-opacity": c.opacity, zIndex: -1 }, c.attributes))[b ? "animate" : "attr"]({ d: this.haloPath(c.size) });
                } else n && n.attr({ d: [] });
                this.state = a;
            }
        },
