...
function Epoch(name,mode,targetelement,multiselect)
{
	...
	if(this.mode == 'popup' && targetelement && targetelement.type == 'text') //if the target element has been set to be an input text box
	{
		...
		this.tgt.onfocus = function () {this.calendar.show1();}; //the calendar will popup when the input element is focused
	...
	this.visible ? this.show1() : this.hide();
}
//-----------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------
Epoch.prototype.show1 = function () //PUBLIC: displays the calendar
{
