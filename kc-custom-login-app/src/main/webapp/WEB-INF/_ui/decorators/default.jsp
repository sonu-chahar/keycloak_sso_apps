				...
				<div class="container-fluid">
					...
					<div class="collapse navbar-collapse navbar-right-main"
						...
						<ul class="nav navbar-nav navbar-right">
							<li><a style="background:none !important;padding: 0 10px;" href="JavaScript:void(0);"><img width="115px" class="img-responsive" src="<%=request.getContextPath()%>/resources/images/swatch-bharat.png" border="0" /></a></li>
							<li class="btn-custom"><a
								href="<%=request.getContextPath()%>/myProfile/showChangePwdPage"><i class="fa fa-fw fa-key"></i> Change Password</a></li>
